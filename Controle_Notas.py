...
def menu_listagem():
    ...
    print(66*"="+"\n")
    print("  5 - Ordenada pelo código")
    print("  9 - Ordenada pelo nome")
    print("  6 - Ordenada pelo idade")  # .......................................<< New change in console'text interface (Adding "3 - Ordenada pelo idade" option)
